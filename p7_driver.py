...
if __name__ == '__main__':
    ...
    clingo = subprocess.Popen(
        "gringo level-core.lp level-style.lp level-sim.lp level-shortcuts.lp -c width=8 | reify | clingo - meta.lp metaD.lp metaO.lp metaS.lp --parallel-mode=4 --outf=2",
        shell=True,
        stdout=subprocess.PIPE,
        stderr=subprocess.PIPE)
    out, err = clingo.communicate()
    ...
    theMap = parse_json_result(out)
    print render_ascii_dungeon(theMap)